package net.mindview.atunit;////: net/net.net.mindview/atunit/AtUnitRemover.java
...
//package net.net.net.mindview.atunit;
//import javassist.*;
...
//import java.io.*;
//import java.util.*;
//import net.net.net.mindview.util.*;
//import static net.net.net.mindview.util.Print.*;
//
...
//          if(ann.getTypeName()
//             .startsWith("net.net.net.mindview.atunit")) {
